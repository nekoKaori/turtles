...
{turtleId:2, turtleName:"Dad", turtleGender:"Boy", turtlePicture:"Images/turtleBasic.png", turtleGenetics:"ABBCCDDEEE"}];
...
function breed(){
	...
	document.getElementById("nameTheChild").innerHTML = "<form> Congrats, Baby Turtle is a " + childGender + "!<br>Please Enter Baby's Name: " + '<input type="text" name="name" value="Baby ' + childGender + '"> <button type="button" onclick="addBaby()">Submit</button></form><br>'
...
function addBaby(){
	...
	turtles.push({turtleId:tLen, turtleName:"Mom", turtleGender:childGender, turtlePicture:babypicture, turtleGenetics:childGenetics});
	populateTable();
}